...
/**
 * REST controller for managing {@link com.example.dlg.domain.Orders}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrdersResource {
     ...
     */
    @GetMapping("/orders")
    public List<Orders> getAllOrders(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Orders");
        return ordersRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Orders> getOrders(@PathVariable Long id) {
        ...
        Optional<Orders> orders = ordersRepository.findOneWithEagerRelationships(id);
